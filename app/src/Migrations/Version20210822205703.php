 ...
 */
final class Version20210822205703 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', username VARCHAR(128) NOT NULL COMMENT \'Email as the username\', roles JSON NOT NULL, password VARCHAR(96) NOT NULL COMMENT \'Use password hash with BCRYPT\', created DATETIME NOT NULL, first_name VARCHAR(96) NOT NULL, last_name VARCHAR(96) NOT NULL, UNIQUE INDEX UNIQ_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE member (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', username VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, created DATETIME NOT NULL, name VARCHAR(96) NOT NULL, UNIQUE INDEX UNIQ_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE member_role (member_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', role_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_ABE1A6367597D3FE (member_id), INDEX IDX_ABE1A636D60322AC (role_id), PRIMARY KEY(member_id, role_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rating (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', vico_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', score INT NOT NULL, comment VARCHAR(1000) NOT NULL, created DATETIME NOT NULL, INDEX IDX_D889262219F89217 (vico_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE role (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', name VARCHAR(20) NOT NULL, description VARCHAR(255) NOT NULL, created DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rating ADD CONSTRAINT FK_D889262219F89217 FOREIGN KEY (vico_id) REFERENCES vico (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE member_role DROP FOREIGN KEY FK_ABE1A6367597D3FE');
        ...
        $this->addSql('ALTER TABLE member_role DROP FOREIGN KEY FK_ABE1A636D60322AC');
        $this->addSql('ALTER TABLE project DROP FOREIGN KEY FK_2FB3D0EE19F89217');
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY FK_D889262219F89217');
